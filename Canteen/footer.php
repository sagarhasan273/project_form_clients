	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Gazipur, Dhaka</p>
					<p class="lead"><a href="#">+8801744291433</a></p>
					<p><a href="#"> redblood1050@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2022 <a href="#">Canteen Management System</a> Developed By :  #######
					<a href=""></a><br>
				</p>
					</div>
				</div>
